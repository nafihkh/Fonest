...
export default function UpdateDeliveryInstructionsMobile({
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fb] pb-24">
      {/* Header */}
      <div className="sticky top-0 z-20 bg-[#f8f9fb] px-4 pb-3 pt-4">
      ...
      <div className="space-y-4 px-4">
        {/* Info banner */}
        <div className="rounded-2xl bg-[#eaf3ff] px-4 py-3">
          <div className="flex items-start gap-3">
            <div className="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-white text-blue-500 shadow-sm">
              <Info size={16} />
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-gray-100 bg-[#fafafa] px-4 py-3 text-[13px] text-gray-800 outline-none"
                />
              </div>
                ...
                <div className="rounded-2xl border border-gray-100 bg-[#fafafa] px-4 py-3">
                  <div className="flex items-start gap-3">
                    ...
                    <textarea
                      ...
                      className="w-full resize-none bg-transparent text-[13px] leading-5 text-gray-700 outline-none"
                    />
                  </div>
                </div>
              </div>
        ...
        <div>
          ...
          <div className="rounded-3xl bg-white p-4 shadow-sm">
            <div className="space-y-4">
              ...
              <div className="rounded-2xl bg-[#fafafa] px-3 py-3">
      ...
      {/* Bottom save button */}
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-[#f8f9fb] px-4 pb-5 pt-3">
        <button
          onClick={handleSubmit}
          disabled={loading}
          className="flex w-full items-center justify-center gap-2 rounded-2xl bg-blue-500 py-3.5 text-[14px] font-semibold text-white shadow-sm disabled:opacity-60"
        >
          <Save size={16} />
