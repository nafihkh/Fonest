  ...
  return (
    <div className="mb-4 rounded-3xl border border-gray-200 bg-white p-4 shadow-sm transition hover:shadow-md dark:border-gray-800 dark:bg-[#10141f]">
      ...
      <div className="mb-4 flex items-start justify-between gap-3">
        ...
        <div className="rounded-full bg-blue-50 px-3 py-1 text-[11px] font-semibold text-blue-600 dark:bg-blue-500/10 dark:text-blue-300">
          {order.orderStatus}
        </div>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="line-clamp-2 text-[12px] font-semibold text-gray-900 dark:text-gray-100">
                    {name}
                  </p>
